...
class GPC_CalcWindow(TkinterDnD.Tk, tk.Toplevel):
    ...
    def __init__(self):
        ...
        self.c.create_image(win_ctr_x,15, image = self.logo_header, anchor = N)

        # initial window setup
        self.rowconfigure(3, {'minsize': 40})
        self.columnconfigure(3, {'minsize': 40})
        self.title("GPC Calculator")
        ...
        self.c.create_text(win_ctr_x, 100, text="Please Select a File to Use for Calculating GPC's", fill = "white", font = ("Segoe UI Variable Text Semibold", 14), anchor=N)
        ...
        label_file_explorer.place(x=win_ctr_x-15, y=140, anchor=N)
        ...
        # setting and positiong the prompt
        self.c.create_text(84, 175, text="Project Distance from Shop:", fill = "white", font = ("Segoe UI Variable Text Semibold", 11), anchor=NW)
        
        self.c.create_text(335, 175, text="Miles", fill = "white", font = ("Segoe UI Variable Text Semibold", 11), anchor=NW)
        ...
        submit = self.c.create_image(win_ctr_x-5, win_ctr_y+90, image=submit_btn_image_normal, tags=["submit_normal_state", "submit_hover_state","submit_click_state"])
        ...
        browse_normal = self.c.create_image(win_ctr_x+211, win_ctr_y+13.5, image=browse_button_image_normal, tags=["browse_normal_state", "browse_highlight_state","browse_click_state"])
        ...
        help = self.c.create_text(win_ctr_x+265, win_ctr_y+115, text="Help", fill="gray", font=("Arial 10"), width=30, tags=["help", "normal","highlight"]) 
